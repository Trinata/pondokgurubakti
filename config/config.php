...
$CONFIG['default']['base_url'] = 'http://localhost/pondokgurubakti/';
$CONFIG['default']['root_path'] = $_SERVER['DOCUMENT_ROOT'].'/pondokgurubakti';

$CONFIG['default']['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/pondokgurubakti/public_assets/';
...
$CONFIG['default']['image'] = array('image/jpeg', 'image/pjpeg','image/png');

$CONFIG['default']['unzip'] = 'zipArchive'; //s_linux or zipArchive

$basedomain = $CONFIG['default']['base_url'];
$rootpath = $CONFIG['default']['root_path'];
